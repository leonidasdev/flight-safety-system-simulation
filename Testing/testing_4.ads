...
package Testing_1 is
    ...
    ------ SCENARIO ----------------------------------------------------- 
    ---------------------------------------------------------------------
    -- Initial_Altitude: Altitude_Samples_Type := 6000;
    --simular ascenso + alabeo simultáneo (+15°, roll ±15°), aumento automático de velocidad hasta el límite (1000 km/h) + aumento de potencia del piloto
    ---------------------------------------------------------------------
    ------ DISTANCE OK---------------------------------------------------
    ...
    Joystick_Simulation: tipo_Secuencia_Joystick :=  -- 1 muestra cada 100ms.
                ( (+00,+00),(+00,+00),(+00,+00),(+00,+00),(+00,+00),
                 ...
                 (+07,-07),(+08,-08),(+09,-09),(+10,-10),(+11,-11),  --4s. inicia maniobra simultanea hacia arriba y hacia la izquierda

                 (+12,-12),(+13,-13),(+14,-14),(+15,-15),(+15,-15),  
                 (+15,-15),(+15,-15),(+15,-15),(+15,-15),(+15,-15),  --5s. mantiene la maniobra
                  
                 (-15,+15),(-15,+15),(-15,+15),(-15,+15),(-15,+15), 
                 (-15,+15),(-15,+15),(-15,+15),(-15,+15),(-15,+15),  --6s. hace la maniobra simultanea hacia abajo y hacia la derecha 
 
                 (-15,+15),(-15,+15),(-15,+15),(-15,+15),(-15,+15),  
                 (-15,+15),(-15,+15),(-15,+15),(-15,+15),(-15,+15),  --7s. mantiene la maniobra

                 (-14,+14),(-13,+13),(-12,+12),(-11,+11),(-10,+10), 
                 (-09,+09),(-08,+08),(-07,+07),(-06,+06),(-05,+05),  --8s. empieza a nivelar

                 (-04,+04),(-03,+03),(-02,+02),(-01,+01),(-01,+01),  
                 ...
                 (+15,+10),(+15,+10),(+15,+10),(+15,+10),(+15,+10),  --14s. hace manobra simultanea a maxima velocidad
    ...
    Power_Simulation: tipo_Secuencia_Power :=  -- next sample every 100ms.
                 ( 800,800,800,800,800, 800,800,800,800,800,   -- 1s.
                   ...
                   832,833,834,835,900, 900,900,900,900,999,   -- 12s.  speed limit testing
                   1000,1001,1000,1000,1000, 1000,1000,1000,1000,1000, -- 13s.  !!!! muy alta --
                   1020,1020,1020,1020,1020, 1020,1020,1020,1020,1020, -- 14s.  !!!!
                   1020,1020,1020,1020,1020, 1020,1020,1020,1020,1020, -- 15s. !!!!  
